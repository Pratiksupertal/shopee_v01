          ...
          frappe.call({
             ...
             callback: function(r) {
                  ...
                  console.log(r.message);
                          frappe.model.set_value(row.doctype, row.name, "invent_size_id", resp["invent_size_id"]);
                          frappe.model.set_value(row.doctype, row.name, "basic_rate", resp["price_list"]);
                          frappe.model.set_value(row.doctype, row.name, "rate", resp["price_list"]);
